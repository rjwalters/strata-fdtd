...
import { FlowParticleRenderer } from "@/components/FlowParticleRenderer"
import { VisualizationModePanel } from "@/components/VisualizationModePanel"
...
import { useExport, type ExportState, type ExportActions } from "@/hooks/useExport"
  ...
  useEffect(() => {
    if (probeData && !selectedProbe) {
      ...
      if (probeNames.length > 0) {
        // This is initialization logic that runs once when data loads
