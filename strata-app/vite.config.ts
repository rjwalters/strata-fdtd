...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      // Resolve strata-ui source directly for HMR and better dev experience
      'strata-ui': path.resolve(__dirname, '../strata-ui/src'),
      // Also resolve strata-ui's internal @/ imports
      '@strata-ui': path.resolve(__dirname, '../strata-ui/src'),
    },
  },
