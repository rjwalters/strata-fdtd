...
export function PlaybackControls({
  ...
  // Use ref for currentFrame in animation loop to avoid stale closure issues
  ...
  useEffect(() => {
    ...
    const animate = (time: number) => {
      if (time - lastTime >= interval) {
        ...
        // Use ref to get current frame value without including in deps
  ...
  }, [isPlaying, fps, speed, totalFrames, setCurrentFrame, setIsPlaying, disabled, loop])
