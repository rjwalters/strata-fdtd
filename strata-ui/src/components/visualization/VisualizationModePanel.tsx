...
export function VisualizationModePanel({
  ...
  const particleCountValue = useMemo(() => [flowParticleConfig.particleCount], [flowParticleConfig.particleCount]);
  const timeScaleValue = useMemo(() => [Math.log10(1 / flowParticleConfig.timeScale)], [flowParticleConfig.timeScale]);
  const particleSizeValue = useMemo(() => [flowParticleConfig.particleSize * 1000], [flowParticleConfig.particleSize]);
  const trailLengthValue = useMemo(() => [flowParticleConfig.trailLength], [flowParticleConfig.trailLength]);
